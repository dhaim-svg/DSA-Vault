...
Traditionsrituale der Gildenmagier. Der **Stab** und die **Kristallkugel** sind die beiden Traditionsartefakte. Alle Stabzauber erfordern den gebundenen Zauberstab (Form und Material sind frei wählbar; besondere Materialien können Fassungsvermögen und Stabzauber beeinflussen, WdZ S. 107); alle Kugelzauber erfordern eine Kugel (Glas oder Bergkristall).

---

## Stabzauber (12 Rituale in vier Gruppen)

12 Stabzauber in vier Gruppen (WdZ S. 108): **Meta** (Bindung des Stabes, Apport), **profan** (Ewige Flamme, Seil des Adepten, Doppeltes Maß, Hammer des Magus), **arkan** (Kraftfokus, Modifikationsfokus, Zauberspeicher, Merkmalsfokus), **esoterisch** (Flammenschwert, Schuppenhaut). Die Bindung ist immer das erste, der Apport immer das letzte Stabritual. **Vol** = Eigenvolumen des Rituals im Stab (Stab hat begrenztes Fassungsvermögen, siehe unten).

| Gruppe | Stabzauber | Erschaffungsprobe | AsP | Vol | Effekt |
|--------|-----------|------------------|-----|-----|--------|
| Meta | **Bindung des Stabes** | KL / CH / FF (+3) | 22 (davon 1 pAsP) | 0 | Grundbindung; erst dann weitere Stabzauber möglich; je 3 zusätzliche pAsP → +1 Fassungsvermögen |
| Meta | **Apport** | MU / IN / CH (+7) | 19 (davon 1 pAsP) | 3 | Stab kehrt auf Befehl zum Magier zurück (GS 15, Reichweite 3 + RkP\* Meilen); immer das letzte Stabritual |
| profan | **Ewige Flamme** | KL / KL / FF (+4) | 23 | 2 | Stab brennt auf Kommando; Voraussetzung für Flammenschwert |
| profan | **Seil des Adepten** | KL / IN / GE (+5) | 21 | 2 | Stab wird zu einem 10 Schritt langen Seil, das sich selbst um Zinne/Haken knotet und auf Befehl wieder löst |
| profan | **Doppeltes Maß** | KL / FF / GE (+4) | 19 | 1 | Stab wächst auf doppelte Länge (ca. 3 Schritt); Variante *Halbes Maß* (halbe Länge; +4 Erschaffungsprobe, +1 Vol) |
| profan | **Hammer des Magus** | MU / CH / KK (+6) | 27 | 3 | Wuchtiger Schlag gegen unbelebte Objekte (3W6 + RkP\* Strukturpunkte, ignoriert Härte); gegen Lebewesen nur indirekter Schaden |
...
### Fassungsvermögen & Eigenvolumen *(WdZ S. 107–109)*
- Jeder Stab hat ein **maximales Fassungsvermögen**, jeder Stabzauber ein **Eigenvolumen** (Vol); ein Stab nimmt Stabzauber auf, bis sein Fassungsvermögen erreicht ist.
- **Grundwerte je Stabform** (S. 108, Text und Tabelle „Exemplarische Zauberstab-Varianten“):
  - gewöhnlicher Zauberstab: **24** Punkte
  - kurzer Stab („um 1 Schritt“): **18** Punkte
  - sehr kurzer Stab („um 1/2 Schritt Länge“): **15** Punkte
  - Stab mit integrierter Kristallkugel: **27** Punkte
- **Erweiterung:** Bei der Bindung des Stabes kann der Adept zusätzliche pAsP investieren — je 3 pAsP vergrößern das Fassungsvermögen um 1 Punkt (S. 109).
- **Besondere Materialien** (Sonderhölzer u. a.) können das Fassungsvermögen verändern (Verweis des Buchs auf SRD 117f.); eine Holzarten-Tabelle nennt WdZ nicht.
- **Kristallkugel im Stab:** beide Bindungsrituale gleichzeitig mit je +2 Zuschlag; der Apport wird nur einmal für beide Komponenten eingebunden (S. 108).
...
|-----------|-------------------|--------------------|----------------|
| Bindung des Stabes | — (keine Aktivierung; die Unzerbrechlichkeit wirkt permanent) | — | — |
| Apport | MU / IN / CH (Aktivierungsdauer 5 Aktionen) | 1 AsP | bis das Artefakt zurückgekehrt ist |
| Ewige Flamme | — (keine Probe) | 1 AsP | beliebig |
| Seil des Adepten | — (keine Probe) | 1 AsP | beliebig |
| Doppeltes Maß | — (keine Probe) | 1 AsP | beliebig; Rückverwandlung = freie Aktion, keine AsP |
| Hammer des Magus | MU / CH / KK (Aktivierungsdauer 3 Aktionen; die Berührung des Ziels erfolgt in der 3. Aktion) | 3 AsP | augenblicklich |
...
- **Volumen:** 1 Punkt
- **Effekt:** Stab wächst auf das Doppelte seiner Länge (in den meisten Fällen ca. 3 Schritt); Durchmesser sinkt nur minimal, Stab bleibt unbiegsam
- **Variante Halbes Maß:** Stab schrumpft auf halbe Länge (Kampfwerte wie kurzer Stab); zusätzlich zum Doppelten Maß: Erschaffungsprobe +4, +1 Volumenpunkt
...
- **Volumen:** 3 Punkte
- **Effekt:** Wuchtiger Schlag gegen unbelebte Objekte (3W6 + RkP\* Strukturpunkte, ignoriert die Härte); gegen Lebewesen nur indirekter Schaden
...
- **Lernkosten:** 150 AP
- **Erschaffungsprobe:** KL / IN / CH (+7)
- **Erschaffungskosten:** 27 AsP
- **Volumen:** 3 Punkte
- **Merkmal:** Metamagie, Kraft
...
- ODEM ARCANUM (normal 4 AsP) kostet nur noch 3 AsP.
- Ein 5-Kampfrunden-ECLIPTIFACTUS (5 AsP Beschwörung + 5 × 1 AsP Aufrechterhaltung = 10 AsP) kostet nur noch 9 AsP.
...
- Im Kampf: Es muss eine reguläre Attacke mit dem Stab gelingen.
- Außerhalb des Kampfes: Die Berührung ist ohne Probe möglich.
...
- **Volumen:** 5 Punkte
- **Effekt:** Stab wird zu Chamäleon (Tarnung) oder Speikobra (Giftangriff); die Form wird bei der Erschaffung festgelegt, das Ritual ist je einmal für beide Formen sprechbar
...
- **Volumen:** 2 Punkte
- **Effekt:** Stab wird zu einem 10 Schritt langen Seil, das sich (in die Luft geworfen) selbständig um Zinne/Haken knotet und auf Befehl wieder löst; zum Verwandeln und Ver-/Entknoten muss der Magier das Seil berühren
- **Aktivierungsprobe:** — (keine Probe)
- **Aktivierungskosten:** 1 AsP
- **Wirkungsdauer:** beliebig
...
- **Gruppe:** Meta-Stabzauber (allgemeines Objektritual, WdZ S. 106)
- **Voraussetzungen:** Bindungsritual des Artefaktes (hier: Bindung des Stabes), MU 12, KL 12, IN 13, CH 13
- **Lernkosten:** 200 AP
- **Erschaffungsprobe:** MU / IN / CH (+7)
- **Erschaffungskosten:** 19 AsP, davon 1 pAsP
- **Volumen:** 3 Punkte
- **Effekt:** Stab kehrt auf Befehl zum Magier zurück (GS 15; Reichweite 3 + RkP\* Meilen)
- **Aktivierungsprobe:** MU / IN / CH (Aktivierungsdauer 5 Aktionen)
- **Aktivierungskosten:** 1 AsP
- **Wirkungsdauer:** bis das Artefakt zurückgekehrt ist
- **Stab-Besonderheiten:** immer das **letzte** Stabritual (S. 108); danach lassen sich keine weiteren Zauber auf den Stab legen (S. 106); bei einem Stab mit integrierter Kristallkugel gilt ein Apport für beide Komponenten (S. 106/108)

*Allgemeiner Regeltext: [[rituale-grundregeln#Apport|Rituale — Grundregeln, Apport]].*
...
| Aspekt | Details |
|--------|---------|
| Material | Glaskugel (ca. 30 D) oder Bergkristall (teurer) |
| Mondphasen | Vollmond begünstigt Bindung und Nutzung; abnehmendes Mondlicht schwächt |
| Anzahl Kugelzauber | 4–7, je nach Kugeltyp und -qualität |
| **Bindung der Kugel** | KL / CH / FF (+5); 13 AsP; 1 pAsP; Grundvoraussetzung |

### Kugelzauber (Auswahl)

| Kugelzauber | Effekt |
|------------|--------|
| **Arkane Analyse** | ANALYS ARCANSTRUKTUR aus der Kugel; ZfP\* mit voller Kraft |
| **Blick in die Ferne** | Hellsicht; Bild von einem entfernten Ort |
| **Gefangenheit der Aura** | MR-Schutz für den Träger |
| **H'szints Auge** | Schutz und Sichtverbindung; ermöglicht Madakristall (Achaz) |
| **Kristallenes Gedächtnis** | Archiv von Thesen; Studierhilfe |
| **Verbindung der Geister** | Telepathie mit anderen Kugelträgern |

---

## Key Takeaways

- Zwölf Stabzauber in vier Gruppen (Meta / profan / arkan / esoterisch); Bindung des Stabes ist immer das erste, Apport immer das letzte Stabritual
...
- [[rituale-grundregeln]] — Allgemeine Ritualregeln, Aktivierungsproben
- [[kristallomanten-rituale]] — Achaz-Kristallkugel, Madakristall (nutzt H'szints Auge)
- [[artefakte]] — ARCANOVI-Herstellung vs. Traditionsartefakte
