...
| **Ausfall** | – | Abwehraktion → Angriff; Verteidiger −4 auf zweite Abwehraktion (−8 wenn Umwandeln verboten; SF Def. Kampfstil senkt je um 4); Verteidiger zu Schritt gezwungen *(Errata 2008)* | KO 12, SF Finte |
...
| **Gezielter Stich** | +4 | Umgeht RS, erzeugt automatisch Wunde; mit Schwertern zusätzlich SF Halbschwert nötig (außer als Schwert geführte Säbel) *(Errata 2008)* | SF Finte |
| **Hammerschlag** | +8 | TP stark erhöht | MU 15, SF Niederwerfen |
| **Todesstoß** | +8 + halber RS | Leichte Wunden + automatische Wunden; mit Schwertern zusätzlich SF Halbschwert nötig (außer als Schwert geführte Säbel) *(Errata 2008)* | MU 15, SF Gezielter Stich |
...
| **Sturmangriff** | +4 AT | Kombination aus Bewegen und Angriff zu einer einzigen Aktion aus vollem Lauf; Angreifer muss Abwehraktion aufgeben; +TP(GS/2 +4) *(Errata 2008)* | MU 12, SF Wuchtschlag |
...
| **Entwaffnen (AT)** | +8 | Waffe aus Hand schlagen; ausführbar mit: Anderthalbhänder, Dolche (nur vs. Dolche/Fechtwaffen/Säbel), Fechtwaffen (nur vs. Fechtwaffen/Dolche/Säbel), Infanteriewaffen u.a. *(Errata 2008)* | KK 12, SF Binden |
...
| **Gegenhalten** | +4 AT (Gegner) | Abwehraktion = simultaner Gegenangriff; bei Distanzverkürzungs-AT: bessere AT gelangt zum Ziel (Angreifer verkürzt DK oder Gegenhaltender stoppt und richtet Schaden an) *(Errata 2008)* | MU 15, GE 12, SF Meisterparade |
...
|----|-----------------|-----|
| Aufmerksamkeit | INI auf Maximum in 1 Aktion; Passierschlag gegen ihn +4 erschwert | 200 (Verbreitung 6) *(Errata 2008)* |
...
| Linkhand | PA-Basis +1; −AT/PA nur −6/−6 mit falscher Hand; verbilligter Erwerb möglich: 225 AP (Linkshänder) bzw. 150 AP (Beidhändig) *(Errata 2008)* | 300 |
...
| Unterwasserkampf | Keine Abzüge unter Wasser | 200 (Verbreitung 2) *(Errata 2008)* |
| Waffe zerbrechen | Gegnerische Klinge zerbrechen | 200 |
| Waffenmeister (Waffe) | Zugang zu Waffenmeister-Sonderfähigkeiten | 400 |
| Waffenspezialisierung | +1/+1 AT/PA mit Waffe; mehrere möglich; Klammeranmerkung zur Peitsche entfällt *(Errata 2008)* | 20×AF |
...
AT → PA oder PA → AT: Umgewandelte Aktion um −4 erschwert. Findet bei INI−8 statt. Einschränkung bei niedriger INI: Beträgt INI−8 weniger als 0, kann keine Abwehraktion in eine Angriffsaktion umgewandelt werden *(Errata 2008)*. Nicht möglich mit: Kettenwaffen, Peitsche, Zweihandflegel, improvisierten Waffen (>2 Schritt); Zweihandschwerter/-säbel und Zweihand-Hiebwaffen können Aktionen umwandeln (es sei denn, länger als 2 Schritt oder improvisiert — betrifft keine der Standardwaffen) *(Errata 2008)* — außer bei SF Defensiver Kampfstil / Aufmerksamkeit / Kampfgespür.
...
- TP(A) werden echt gerundet (nicht abgerundet). *(Errata 2008)*
...
### Raufen
Schläge, Tritte, Kopfstöße, Bisse usw. – 1W6 TP(A) (Knauf: 1W6+2 TP(A) *(Errata 2008)*).
...
- S. 48: Talent Dolche — Entwaffnen ist nur aus der Attacke möglich.
- S. 49: Talent Kettenstäbe — Doppelangriff streichen, Betäubungsschlag ergänzen.
- S. 50: Talent Schwerter — Mit etlichen Säbeln (Amazonen-, Kusliker, gewöhnlicher, Robbentöter), Wolfsmesser und Rapier sind auch bei Schwert-Führung keine Niederwerfen-Manöver möglich. Mit SF Halbschwert: Gezielte Stiche und Todesstöße möglich (ausgenommen als Schwert geführte Amazonen- und gewöhnliche Säbel). Mit Kurzschwert: keine Befreiungsschläge; kein TP-Bonus im Reiterkampf; kein SF Halbschwert nötig für Gezielten Stich/Todesstoß.
- S. 51: Talent Zweihandschwerter/-säbel — Entwaffnen und Umreißen nur mit Kenntnis von Halbschwert.
- S. 58: Beengte Umgebung — Als 'lange Schwungwaffen' zählen auch alle als Anderthalbhänder geführten Schwerter. Tabelle: Infanteriewaffen AT +2 / PA +2, Speere PA +2.
- S. 59: Manöver allgemein — Einige Manöver und SF des bewaffneten Kampfes sind auch im waffenlosen Kampf einsetzbar (vgl. S. 87).
- S. 59f: Ausfall — Verteidiger erleidet −4 auf zweite Abwehraktion (−8 wenn Umwandeln verboten; SF Def. Kampfstil senkt je um 4). Verteidiger zu Schritt-Freier-Aktion gezwungen; fehlt diese, trotzdem zurückgedrängt +4 PA-Einbußen.
- S. 61: Doppelangriff — Auch mit Talent Peitsche nicht möglich.
- S. 61: Entwaffnen als AT — Vollständige Liste der erlaubten Talente: Anderthalbhänder, Dolche (nur vs. Dolche/Fechtwaffen/Säbel), Fechtwaffen (nur vs. Fechtwaffen/Dolche/Säbel), Infanteriewaffen u.a.
- S. 62: Gezielter Stich mit Schwertern erfordert zusätzlich SF Halbschwert.
- S. 64: Sturmangriff — Kombination aus Bewegen und Angriff zu einer einzigen Aktion; Angreifer muss Abwehraktion aufgeben.
- S. 65: Todesstoß mit Schwertern erfordert zusätzlich SF Halbschwert.
- S. 67: Ausweichen im Spiel mit Bodenplänen (◆◆) — Das Entfernen ein Feld vom Angreifer gilt nur beim gewöhnlichen (nicht gezielten) Ausweichen.
- S. 67: Defensiver Kampfstil — Neben Kettenwaffen und Zweihandflegel auch Peitschen, improvisierte Waffen und Waffen > 2 Schritt Länge ungeeignet. Begriff "meisterlich ausweichen" → "gezielt ausweichen".
- S. 68f: Gegenhalten — Bei Distanzverkürzungs-AT: bessere AT kommt zum Ziel (entweder Angreifer in kurze DK mit halbierten Schaden oder Gegenhaltender stoppt Verkürzung und richtet vollen Schaden an).
- S. 70: Parierwaffen und DK — Mit Parierwaffe (Haupt- + Parierwaffe) auch in DK der Hauptwaffe Manöver Binden und Meisterparade möglich.
- S. 70: Schild-Manöver — Verbotene Manöver: Doppelangriff, (Meisterliches) Entwaffnen, Klingensturm, Parade mit Parierwaffe, Tod von Links, Umreißen, Waffe zerbrechen. Ausfall und Finte +2 erschwert (Finte-Erschwernis gilt nicht bei kleinem Schild). Meisterparade nur mit Schildkampf II; Windmühle nur mit kleinem Schild. Schild-als-Parierwaffe: nur Umreißen verboten.
- S. 71: Windmühle — Angriff aus Abwehraktion heraus; kein Umwandeln nötig; findet in INI-Phase des Angreifers statt; gewürfelt auf PA-Wert.
- S. 71 (◆◆): Windmühle — Zielkämpfer kann Windmühle mit Erschwernis parieren, jedoch nur wenn ihm noch eine Abwehraktion zusteht.
- S. 71: Zweite Parade — 'Falsche Hand' bedeutet: zusätzliche PA nur bei Haupt- + Parierwaffe/Schild-Kombination; reines Führen einer Parierwaffe/Schild in falscher Hand reicht nicht.
- S. 71/72: Zusatzaktionen (Parierwaffen II / Schildkampf II / BK II) — Immer nach regulären Aktionen; nicht zuerst Zusatzaktion, dann reguläre Parade umwandeln. Zusätzliche Parierwaffen-/Schildparaden nicht in AT umwandeln.
- S. 72: SF Halbschwert — Auch mit (zweihändig geführten) Speeren und Stäben einsetzbar. Erlaubt Zweihandschwertern/-säbeln auch das Umreißen.
- S. 72 (◆◆): SF Halbschwert — In Halbschwert-Stellung sinkt jede DK einer Waffe um eine Stufe: aus N und HN → H; aus NS → HN; aus S → N.
- S. 73 (◆◆): SF Aufmerksamkeit — Verbreitung 6.
- S. 75: SF Klingentänzer — Die +6 bei INI-Bestimmung stammen aus den Voraussetzungen SF Kampfgespür und Kampfreflexe.
- S. 75: SF Linkhand — Verbilligter Erwerb: 225 AP (Linkshänder) bzw. 150 AP (Beidhändig).
- S. 77 (◆◆): SF Unterwasserkampf — Verbreitung 2.
- S. 80: Kämpfe mit mehreren Beteiligten — Ausweichen wird pro zusätzlichem Gegner um 2 Punkte erschwert (nicht nur 1), maximal 4 Punkte.
- S. 81: Abwarten — Wenn eine Person normale und die andere verzögerte Aktion hat (oder beide verzögert), entscheidet der höhere ursprüngliche INI-Wert.
- S. 81: Umwandeln — Bei INI−8 < 0 kein Umwandeln von Abwehr- in Angriffsaktion. Zweihandschwerter/-säbel und Zweihand-Hiebwaffen dürfen umwandeln (außer länger als 2 Schritt oder improvisiert).
- S. 86: Meucheln — TP(A) werden echt gerundet (nicht abgerundet).
- S. 88: Raufen/Knaufschlag — TP des Knaufschlags: 1W6+2 TP(A).
- S. 89: Waffenlose Kampftechniken — AT/PA-Verbesserungen verschiedener Stile kombinierbar; Besonderheiten nicht kombinierbar. HEXENKRALLEN (Zwanzig Krallen) verbessert nicht die TP von Hruruzat-Tritten. ELEMENTARE LEIBER können TP von Schlägen/Tritten verbessern. Kämpfer mit Orchideen oder Veteranenhänden können Besonderheit des Gladiatorenstils nicht nutzen.
- S. 91–93: Waffenlose Manöver INI-Verluste — Fußfeger, Niederringen, Wurf: Opfer −2W6 INI; Niederringen: Angreifer auch −1W6 INI. Sprung/Sprungtritt: Ausführender −1W6 INI.
- S. 92: Schwanzschlag kann mit anderen waffenlosen Manövern kombiniert werden.
- S. 94: Ladezeiten Bögen — Ausführliche Regelklarstellung: Ladezeit = Schussvorbereitung (ohne Schuss-Aktion). Normaler Schuss = Ladezeit + 1 Aktion Schuss. SF Schnellladen: fasst Einlegen + Spannen zusammen (−1 Aktion). Bogen bereits gespannt: nur noch 1 Aktion Schuss nötig (nicht 2 Aktionen weniger). In keinem Fall unter 1 Aktion. 2. Schuss/KR (je 1 Aktion): +4 Erschwernis.
- S. 96/107: Anmerkungen zur Schildführung beim Zufallstreffer können gestrichen werden.
- S. 103 (◆◆): Ausweichen im Reiterkampf — Satz "Diese Zuschläge werden durch Reiterkampf/Kriegsreiterei nicht reduziert" entfällt.
- S. 111: Gezielter Schuss — Benötigt halben Grundaufschlag (Spalte: Schütze) Aktionen Zielen; Scharfschützen 2 Aktionen weniger; Meisterschützen generell nur 1 Zusatzaktion.
- S. 115: Parade-Einschränkungen — Auch für Dolche gilt Richtschwert als Zweihand-Hiebwaffe, Rondrakamm als Zweihand-Schwert. Anderthalbhänder und Tuzakmesser gelten als Anderthalbhänder (üblicherweise parierbar).
- S. 161: Schwelle des Todes — Lebensbedrohliche Zustände treten bei null oder weniger LeP ein (nicht bei LE ≤ 5).
- S. 198: Tabelle Besondere Kampfsituationen — Falscher Hand (Beidhänd. Kampf I): AT +3 / PA +3 (nicht +6/+6).
- S. 208: Initiative-Übersicht — Im Feld 0: "Bei weniger als 0 Verlust einer Angriffsaktion".
