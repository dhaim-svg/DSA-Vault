---
name: sprint-wrap
description: Schließt den laufenden Dashboard-Sprint (helden/_tools/) ab -- Verifikation, BACKLOG.md, handoff.md, CLAUDE.md-Sprint-Nr. Nutzen bei "/sprint-wrap", "Sprint abschließen".
...
Schreibe `helden/_tools/sprints/sprint-{NNN}/handoff.md` nach der Vorlage
`.claude/skills/sprint-wrap/templates/handoff.md`.
