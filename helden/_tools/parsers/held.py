...
# but '[[' ends the path: an unclosed '[[' must not swallow the real link behind it. The display text follows the
# same rule for '[[' (a single ']' cannot occur there: the group already excludes ']').
