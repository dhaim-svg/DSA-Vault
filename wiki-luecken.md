...
- **Nicht geändert:** Die Tabelle wurde in Sprint 022 bewusst nicht umgebaut (eigener Wiki-Auftrag); der Artikel trägt nur den Hinweis `*(Zählung „13“ vs. 11 Namen …)*`. Die Abschnitte zu Doppeltem Maß und Schuppenhaut in `stabzauber.md` weisen die ungeprüften Angaben als solche aus.
