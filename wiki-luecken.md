...
### L24: Stabzauber — Zählung „13 Rituale“ nicht belegt; Tabellenwerte weichen teils vom Buch ab
...
- **Nicht geändert:** Die Tabelle wurde in Sprint 022 bewusst nicht umgebaut (eigener Wiki-Auftrag); der Artikel trägt nur den Hinweis `*(Zählung „13“ vs. 11 Namen …)*`. Die Abschnitte zu Doppeltem Maß, Schuppenhaut und Bindung des Stabes in `stabzauber.md` weisen die vom Buch abweichenden Angaben als solche aus.
- **Vorschlag:** Tabelle gegen WdZ S. 106–111 neu aufsetzen (Apport als 12. Zeile oder als eigener Abschnitt, Überschrift „12 Rituale“ bzw. Gruppen Meta/profan/arkan/esoterisch, Doppeltes Maß / Schuppenhaut / Bindung korrigieren, Fassungsvermögen statt „Vol je Holzart“), danach die Key Takeaways gegenprüfen. Vollständige Detailregeln für die sieben knappen Abschnitte nachziehen (siehe L25).
...
- **Befund / Stand:**
  ...
  - (c) **Namensabgleich Held ↔ Wiki:** Held „Fackel“ = Wiki „Ewige Flamme“; „Stabverlängerung“ = vermutlich „Doppeltes Maß“ (unbestätigt, siehe L24); „Bindung“ = „Bindung des Stabes“; „Seil (des Adepten)“ = „Seil des Adepten“. Die Anker müssen den Wiki-Namen exakt tragen, Anzeigetext darf der Heldenname bleiben.
