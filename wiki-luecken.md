...
### L25: Ritual-Artikelvorschau — Voraussetzungen im Wiki und im Heldendokument ✅ *behoben 2026-09-20 (Sprint 023 T1/T2/T6)*
...
- **Befund / Stand:**
  ...
  - (b) **Erledigt (Sprint 023 T6, ausdrückliche User-Freigabe für diese eine Änderung):** In `helden/illaen-baernhold/rituale.md` trägt jede der 9 Stabzauber-Zeilen jetzt einen Anker-Link `[[wiki/dsa-4.1/rituale/stabzauber#<Wiki-Name>\|<Anzeige>]]`; der Anzeigetext blieb wortgleich (Dashboard-Render und `load_held(...)['rituale']` unverändert), die Werte der Zeilen wurden nicht angefasst. Ein Konsistenztest (`test_held_stabzauber_anchor_links_hit_a_section_of_the_wiki_article`) erkennt, wenn eine Wiki-Überschrift und ein Anker im Bogen auseinanderlaufen.
...
- **Stand:** (a)–(c) erledigt; die Ritual-Artikelvorschau im Dashboard (Zauber-Tab, analog SF-Vorschau) ist damit voraussetzungsfrei startklar, aber noch nicht gebaut. Offen dafür: die Zeile „Stabverlängerung“ = „Doppeltes Maß“ ist eine semantische Zuordnung — im Spiel gegenprüfen.
